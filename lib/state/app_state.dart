...
class AppState extends ChangeNotifier {
  ...
  String get kiranaName => _kiranaStoreName;
  String get kiranaLocation => _kiranaAddress;
  ...
  void updateKiranaProfile({
    ...
    if (name != null && name.isNotEmpty) _kiranaStoreName = name;
    ...
    if (location != null && location.isNotEmpty) _kiranaAddress = location;
  ...
  String get restaurantLocation => _restaurantAddress;
  ...
  String get restaurantHours => _restaurantOperatingHours;
  ...
  void updateRestaurantProfile({
    ...
    if (location != null && location.isNotEmpty) _restaurantAddress = location;
    ...
    if (hours != null && hours.isNotEmpty) _restaurantOperatingHours = hours;
  ...
  String get vendorName => _vendorBusinessName;
  ...
  String get vendorLocation => _vendorAddress;

  String _vendorGstin = '29AAAAA0000A1Z5';
  String get vendorGstin => _vendorGstin;
  String get vendorLicenseNumber => _vendorGstin;
  ...
  void updateVendorProfile({
    ...
    if (name != null && name.isNotEmpty) _vendorBusinessName = name;
    ...
    if (location != null && location.isNotEmpty) _vendorAddress = location;
    if (gstin != null && gstin.isNotEmpty) _vendorGstin = gstin;
    if (licenseNumber != null && licenseNumber.isNotEmpty) _vendorGstin = licenseNumber;
